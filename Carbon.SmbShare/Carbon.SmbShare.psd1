...
@{
    ...
    RootModule = 'Carbon.SmbShare.psm1'

    # Version number of this module.
    ModuleVersion = '1.0.0'

    # ID used to uniquely identify this module
    GUID = '6961a277-a7fe-4dac-a8d8-cb78c5116b30'
    ...
    Description = 'PowerShell module for installing, testing, and uninstalling SMB file shares on Windows.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.SmbShare'
            ...
            ReleaseNotes = 'https://github.com/webmd-health-services/Carbon.SmbShare/blob/main/CHANGELOG.md'
